...
async function main() {
    ...
    if (configs.owner_mnemonic !== undefined) {
        ...
        try {
            console.log('Trying unban...')
            const result = await nftContract.methods
                .changeAdminLists('0x7e4890A6d55d1a35f8570bB78EAc98e8e8704d31', "", 0, false).send({ from: configs.proxy_address });
            console.log("Unbanned! Transaction: " + result.transactionHash);
            console.log(result)
        } catch (e) {

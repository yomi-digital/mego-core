...
async function deploy() {
    try {
        ...
        if (
            ...
            child_process.execSync('sudo PROVIDER="' + configs.provider + '" MNEMONIC="' + configs.proxy_mnemonic + '" GATED="' + configs.gated_address + '"  CONFIG="' + './configs/' + argv._ + '.json' + '" truffle deploy --network ' + configs.network + ' --reset', { stdio: 'inherit' })
